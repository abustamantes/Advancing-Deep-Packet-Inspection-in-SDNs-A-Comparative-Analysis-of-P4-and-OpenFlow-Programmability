...
header http_payload_header_t {
    bit<32> payload_start;
}
...
struct headers {
    ...
    tcp_t        tcp;
    arp_t        arp;
    http_payload_header_t http_payload;
    http_t http;
    icmp_t icmp;
...
control MyIngress(inout headers hdr,
    ...
    action set_apply_dst_tcp_port_80() {
        meta.apply_dst_tcp_port_80 = true;
    }
    ...
    table filter_method {
        key = {
            ...
            hdr.http.method: ternary;
            hdr.http.host: ternary;
        }
        actions = {
            forward_method;
            drop;
            set_apply_dst_tcp_port_80;
        }
        size = 256;
        default_action = set_apply_dst_tcp_port_80();
        //default_action = drop();
    }
